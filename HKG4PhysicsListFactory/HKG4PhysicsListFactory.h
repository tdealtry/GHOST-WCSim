#ifndef HKG4PhysicsListFactory_H
#define HKG4PhysicsListFactory_H
...
namespace HK {
	namespace GHOST {
		namespace G4 {
			class HKG4PhysicsListFactory : public Tool {

			public:

				HKG4PhysicsListFactory();  ///< Simple constructor
