...
///////////////////
{
	...
	public:  // with description
		...
		inline int operator==(const WCSimTrajectory& right) const { return (this == &right); }
		...
		inline G4String GetCreatorProcessName() const { return creatorProcess; }
		...
		inline G4ThreeVector GetStoppingPoint() const { return stoppingPoint; }

		inline G4VPhysicalVolume* GetStoppingVolume() const { return stoppingVolume; }

		inline void SetStoppingPoint(G4ThreeVector& currentPosition) { stoppingPoint = currentPosition; }

		inline void SetStoppingVolume(G4VPhysicalVolume* currentVolume) { stoppingVolume = currentVolume; }
