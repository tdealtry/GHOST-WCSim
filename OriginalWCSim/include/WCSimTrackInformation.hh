...
class WCSimTrackInformation : public G4VUserTrackInformation {
	...
	public:
		...
		WCSimTrackInformation() :
		    saveit(false), primaryParentID(-99) {}  // TF: initialize to value with NO meaning instead of DN
		...
		inline int operator==(const WCSimTrackInformation& right) const { return (this == &right); }
