...
WCSimLC::WCSimLC(const G4String& name, G4Material* bulkMaterial, G4int LCType) :
	...
	if(OpLCMirrorSurface == NULL) {
		...
		G4double REFLECTIVITY_mirror[NUMENTRIES_water] = {
			REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror,
			REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror,
			REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror,
			REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror,
			REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror,
			REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror,
			REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror, REF_mirror,
			REF_mirror, REF_mirror, REF_mirror, REF_mirror
		};
	...
	G4Polycone* conc_solid = new G4Polycone(name + "_plastic", 0, 2 * M_PI, n, z, rin, rout);
...
G4double WCSimLC::Tsukada_z_from_r(double radius) {
	...
	G4double z2;
	z2 = ((-par[2] * radius - par[4]) / (2 * par[1]) -
	      sqrt((((par[2] * radius + par[4]) * (par[2] * radius + par[4])) / (2 * par[1] * 2 * par[1])) -
	           ((par[0] * radius * radius + par[3] * radius + 1) / par[1])));
	z2 = z2 * 5. / 3.;
