	...
	if(x < *angle || x >= *(angle + ncount - 1)) {
		...
		for(Int_t i = 0; i != ncount; i++) {
			if(x >= *(angle + i) && x < *(angle + i + 1)) {
				return (x - *(angle + i)) / (*(angle + i + 1) - *(angle + i)) * (*(quantity + i + 1)) +
				       (*(angle + i + 1) - x) / (*(angle + i + 1) - *(angle + i)) * (*(quantity + i));
			}
		}
	}
...
G4String PMT20inch::GetPMTName() {
	G4String PMTName = "20inch";
	return PMTName;
}

G4double PMT20inch::GetExposeHeight() {
	return .18 * m;
}

G4double PMT20inch::GetRadius() {
	return .254 * m;
}

G4double PMT20inch::GetPMTGlassThickness() {
	return 0.4 * cm;
}
...
double PMT20inch::SaturFactor(double Q, double threshold = -1) {
	if(threshold == -1)
		return 1;  // no saturation case
	double saturFactor =
	    (Q < threshold) ?
	        1 :
	        (100 + 0.008632 * (threshold - Q)) /
	            100;  // expression found for SK 20inch PMT, assumed to be correct for other types
	return saturFactor;
}

G4double* PMT20inch::Getqpe() {
	static G4double qpe0[501] = { // 1
		                          0.000000,
		                          0.000000,
		                          0.000000,
		                          0.000000,
...
G4double* PMT20inch::GetQEWavelength() {
	static G4double wavelength_value[20] = { 280., 300., 320., 340., 360., 380., 400., 420., 440., 460.,
		                                     480., 500., 520., 540., 560., 580., 600., 620., 640., 660. };
	return wavelength_value;
}

G4double* PMT20inch::GetQE() {
	static G4double QE[20] = { 0.00, .0139, .0854, .169,  .203,  .206,  .211,   .202,   .188,   .167,
...
G4String PMT8inch::GetPMTName() {
	G4String PMTName = "8inch";
	return PMTName;
}

G4double PMT8inch::GetExposeHeight() {
	return 91.6 * mm;
}

G4double PMT8inch::GetRadius() {
	return 101.6 * mm;
}

G4double PMT8inch::GetPMTGlassThickness() {
	return 0.55 * cm;
}  // currently the same as 10inch
...
G4double* PMT8inch::GetQEWavelength() {
	static G4double wavelength[20] = { 280., 300., 320., 340., 360., 380., 400., 420., 440., 460.,
		                               480., 500., 520., 540., 560., 580., 600., 620., 640., 660. };
	return wavelength;
}
...
G4String PMT5inch::GetPMTName() {
	G4String PMTName = "5inch";
	return PMTName;
}

G4double PMT5inch::GetExposeHeight() {
	return 57. * mm;
}  // rough estimation

G4double PMT5inch::GetRadius() {
	return 63.5 * mm;
}

G4double PMT5inch::GetPMTGlassThickness() {
	return 0.55 * cm;
}  // currently the same as 10inch
...
G4double* PMT5inch::GetQEWavelength() {
	static G4double wavelength[20] = { 280., 300., 320., 340., 360., 380., 400., 420., 440., 460.,
		                               480., 500., 520., 540., 560., 580., 600., 620., 640., 660. };
	return wavelength;
}
...
G4String PMT10inch::GetPMTName() {
	G4String PMTName = "10inch";
	return PMTName;
}

G4double PMT10inch::GetExposeHeight() {
	return 117. * mm;
}

G4double PMT10inch::GetRadius() {
	return 127. * mm;
}

G4double PMT10inch::GetPMTGlassThickness() {
	return 0.55 * cm;
}
...
G4double* PMT10inch::GetQE() {
	static G4double QE[20] = { 0.00, .0375, .13, .195, .22,  .23, .24,  .24, .225, .205,
		                       .18,  .16,   .14, .085, .065, .05, .035, .02, .005, 0.0 };
	return QE;
}

G4double* PMT10inch::GetQEWavelength() {
	static G4double wavelength[20] = { 280., 300., 320., 340., 360., 380., 400., 420., 440., 460.,
		                               480., 500., 520., 540., 560., 580., 600., 620., 640., 660. };
	return wavelength;
}
...
G4String PMT3inch::GetPMTName() {
	G4String PMTName = "3inch";
	return PMTName;
}

G4double PMT3inch::GetExposeHeight() {
	return 20. * mm;
}

G4double PMT3inch::GetRadius() {
	return 40. * mm;
}

G4double PMT3inch::GetPMTGlassThickness() {
	return 0.10 * cm;
}
...
G4String PMT3inch_ETEL9302B::GetPMTName() {
	G4String PMTName = "3inch_ETEL9302B";
	return PMTName;
}

G4double PMT3inch_ETEL9302B::GetExposeHeight() {
	return 29. * mm;
}

G4double PMT3inch_ETEL9302B::GetRadius() {
	return 39. * mm;
}

G4double PMT3inch_ETEL9302B::GetPMTGlassThickness() {
	return 0.40 * cm;
}
...
G4double* PMT3inch_ETEL9302B::GetQE() {
	static G4double QE[20] = { 0.00, .005, .09, .21,  .28, .30, .29,  .28,  .26,  .24,
		                       .22,  .18,  .13, .075, .04, .02, .008, 0.00, 0.00, 0.00 };
	return QE;
}

G4double* PMT3inch_ETEL9302B::GetQEWavelength() {
	static G4double wavelength[20] = { 260., 280., 300., 320., 340., 360., 380., 400., 420., 440.,
...
G4String PMT3inchGT::GetPMTName() {
	G4String PMTName = "3inchGT";
	return PMTName;
}

G4double PMT3inchGT::GetExposeHeight() {
	return 20. * mm;
}

G4double PMT3inchGT::GetRadius() {
	return 40. * mm;
}

G4double PMT3inchGT::GetPMTGlassThickness() {
	return 0.10 * cm;
}
...
G4String PMT10inchHQE::GetPMTName() {
	G4String PMTName = "10inch";
	return PMTName;
}

G4double PMT10inchHQE::GetExposeHeight() {
	return 117. * mm;
}

G4double PMT10inchHQE::GetRadius() {
	return 127. * mm;
}

G4double PMT10inchHQE::GetPMTGlassThickness() {
	return 0.55 * cm;
}

G4double PMT10inchHQE::HitTimeSmearing(double Q, double TTSFF = 1.0) {
#ifdef WCSIMPMTOBJECT_VERBOSE
	G4cout << "++++++++++++++PMT10inchHQE+++++++++++++++++++++++++++++++++++++++++ TTSFF = " << TTSFF
	       << G4endl;
#endif
	double timingConstant   = 2.0;
	double timingResolution = 0.33 + sqrt(timingConstant / Q);
...
G4double* PMT10inchHQE::GetQE() {
	static G4double QE[20] = { 0.00,  .0502, .2017, .2933, .3306, .3396, .3320, .3168, .2915, .2655,
		                       .2268, .1971, .1641, .1102, .0727, .0499, .0323, .0178, .0061, 0.00 };
	return QE;
}

G4double* PMT10inchHQE::GetQEWavelength() {
	static G4double wavelength[20] = { 280., 300., 320., 340., 360., 380., 400., 420., 440., 460.,
		                               480., 500., 520., 540., 560., 580., 600., 620., 640., 660. };
	return wavelength;
}
...
G4String PMT12inchHQE::GetPMTName() {
	G4String PMTName = "12inch";
	return PMTName;
}

G4double PMT12inchHQE::GetExposeHeight() {
	return 118. * mm;
}

G4double PMT12inchHQE::GetRadius() {
	return 152.4 * mm;
}

G4double PMT12inchHQE::GetPMTGlassThickness() {
	return 0.55 * cm;
}

G4double PMT12inchHQE::HitTimeSmearing(double Q, double TTSFF = 1.0) {
#ifdef WCSIMPMTOBJECT_VERBOSE
	G4cout << "++++++++++++++++++PMT12inchHQE+++++++++++++++++++++++++++++++++++++ TTSFF = " << TTSFF
	       << G4endl;
#endif
	double timingConstant   = 2.0;
	double timingResolution = 0.33 + sqrt(timingConstant / Q);
...
G4double* PMT12inchHQE::GetQEWavelength() {
	static G4double wavelength[20] = { 280., 300., 320., 340., 360., 380., 400., 420., 440., 460.,
		                               480., 500., 520., 540., 560., 580., 600., 620., 640., 660. };
	return wavelength;
}
...
G4String HPD20inchHQE::GetPMTName() {
	G4String PMTName = "HPD20inchHQE";
	return PMTName;
}

G4double HPD20inchHQE::GetExposeHeight() {
	return .192 * m;
}

G4double HPD20inchHQE::GetRadius() {
	return .254 * m;
}

G4double HPD20inchHQE::GetPMTGlassThickness() {
	return 0.3 * cm;
}
...
double HPD20inchHQE::HitTimeSmearing(double Q, double = 1.0) {
	...
	highcharge_param[0] = 2 * sig_param[0] * sig_param[1] * sig_param[3] * sqrt(sig_param[3]) *
	                      exp(-sig_param[1] * sig_param[3]);
	highcharge_param[1] =
	    sig_param[0] *
	    ((1 - 2 * sig_param[1] * sig_param[3]) * exp(-sig_param[1] * sig_param[3]) + sig_param[2]);
...
G4double* HPD20inchHQE::GetQE() {
	static G4double QE[20] = { 0.00,  .0008, .1255, .254962, .2930, .3127, .3130, .2994, .2791, .2491,
...
G4double HPD20inchHQE::GetDarkRate() {
	const G4double rate = 4.2 * CLHEP::kilohertz;  // Based on HQE 20in R3600 rate from EGADS Nov 2014, needs
	                                               // to be updated with latest values (ToDo)
	return rate;
}
...
// Information for the HPD12inchHQE is identical to the HPD20inchHQE, except for GetPMTName, GetRadius and
// GetExposeHeight.
...
G4String HPD12inchHQE::GetPMTName() {
	G4String PMTName = "HPD12inchHQE";
	return PMTName;
}

G4double HPD12inchHQE::GetExposeHeight() {
	return 118. * mm;
}  // Assumed to be the same as the PMT12inchHQE.

G4double HPD12inchHQE::GetRadius() {
	return 152.4 * mm;
}  // 12 inches

G4double HPD12inchHQE::GetPMTGlassThickness() {
	return 0.3 * cm;
}
...
G4String BoxandLine20inchHQE::GetPMTName() {
	G4String PMTName = "BoxandLine20inchHQE";
	return PMTName;
}

G4double BoxandLine20inchHQE::GetExposeHeight() {
	return .18 * m;
}

G4double BoxandLine20inchHQE::GetRadius() {
	return .254 * m;
}

G4double BoxandLine20inchHQE::GetPMTGlassThickness() {
	return 0.4 * cm;
}
...
G4double* BoxandLine20inchHQE::GetQE() {
	G4double correctionFactor =
	    1. / 0.73;  // Correction factor added in July 2015 to scale the output of B&L PDs to 2.27 times the
	                // 20" PMTS based on Hamamatsu simulation. This was done in Pull Request #98 and will be
	                // removed once a more permanent solution is found.
	static G4double QE[20] =  // TF: to resolve "narrowing conversion" error in C++0x, make array G4double
	    { 0.00 * correctionFactor,    .0008 * correctionFactor, .1255 * correctionFactor,
		  .254962 * correctionFactor, .2930 * correctionFactor, .3127 * correctionFactor,
		  .3130 * correctionFactor,   .2994 * correctionFactor, .2791 * correctionFactor,
		  .2491 * correctionFactor,   .2070 * correctionFactor, .1758 * correctionFactor,
		  .1384 * correctionFactor,   .0779 * correctionFactor, .0473 * correctionFactor,
		  .0288 * correctionFactor,   .0149 * correctionFactor, .0062 * correctionFactor,
		  .0002 * correctionFactor,   .0001 * correctionFactor };
...
// Information for the BoxandLine12inchHQE is identical to the BoxandLine20inchHQE, except for GetPMTName,
// GetRadius and GetExposeHeight.

BoxandLine12inchHQE::BoxandLine12inchHQE() {}

BoxandLine12inchHQE::~BoxandLine12inchHQE() {}

G4String BoxandLine12inchHQE::GetPMTName() {
	G4String PMTName = "BoxandLine12inchHQE";
	return PMTName;
}

G4double BoxandLine12inchHQE::GetExposeHeight() {
	return 118. * mm;
}

G4double BoxandLine12inchHQE::GetRadius() {
	return 152.4 * mm;
}

G4double BoxandLine12inchHQE::GetPMTGlassThickness() {
	return 0.4 * cm;
}
...
G4double* BoxandLine12inchHQE::GetQE() {
	G4double correctionFactor =
	    1. / 0.73;  // Correction factor added in July 2015 to scale the output of B&L PDs to 2.27 times the
	                // 20" PMTS based on Hamamatsu simulation. This was done in Pull Request #98 and will be
	                // removed once a more permanent solution is found.
	static G4double QE[20] = { 0.00 * correctionFactor,    .0008 * correctionFactor, .1255 * correctionFactor,
		                       .254962 * correctionFactor, .2930 * correctionFactor, .3127 * correctionFactor,
		                       .3130 * correctionFactor,   .2994 * correctionFactor, .2791 * correctionFactor,
		                       .2491 * correctionFactor,   .2070 * correctionFactor, .1758 * correctionFactor,
		                       .1384 * correctionFactor,   .0779 * correctionFactor, .0473 * correctionFactor,
...
G4double BoxandLine12inchHQE::GetDarkRate() {
	...
	// A different reference: 4.43*CLHEP::kilohertz;   //R11780 HQE value from Table4, NIMA 712 p162-173
	// (2013)
...
//   next: use effective CE/QE as function of theta to correctly simulate edge effect (increase in QE,
//   decrease in CE)
//
...
G4String PMT3inchR12199_02::GetPMTName() {
	G4String PMTName = "PMT3inchR12199_02";
	return PMTName;
}
...
G4double PMT3inchR12199_02::GetRadius() {
	return 0.04 * m;
}  // 0.036*m;} //.0400*m;}   //radius at z = exposeheight of photocathode. In ConstructPMT, we use
   // sphereRadius for the radius of curvature

G4double PMT3inchR12199_02::GetPMTGlassThickness() {
	return 0.1 * cm;
}  // TF: from Hamamatsu Tech Sheet, photocathode >=36mm, so this yields in thickness <= 2.35mm. Currently
   // will use 1mm (larger cathode) until measured!

// Currently based on 8" (instead of 20")
// But shifted to requirements (2ns TTS FWHM) for 1 pe
double PMT3inchR12199_02::HitTimeSmearing(
    double Q,
    double TTSFF = 1.0 /*, double linearity = 0. meaning linearity default = false*/) {
	double timingConstant = 1.890;
	double timingResolution;
	double Smearing_factor;
	// if (linearity == 0){
...
G4double* PMT3inchR12199_02::GetQEWavelength() {
	...
	// static G4double wavelength_value[20] = { 280., 300., 320., 340., 360., 380., 400., 420., 440., 460.,
	// 480., 500., 520., 540., 560., 580., 600., 620., 640., 660.};
	static G4double wavelength_value[21] = { 300., 320., 340., 360., 380., 400., 420., 440., 460., 480., 500.,
...
G4double* PMT3inchR12199_02::GetQE() {
	...
	static G4double QE[21] = { .0787 * correctionFactor, .1838 * correctionFactor, .2401 * correctionFactor,
		                       .2521 * correctionFactor, .2695 * correctionFactor, .2676 * correctionFactor,
		                       .2593 * correctionFactor, .2472 * correctionFactor, .2276 * correctionFactor,
		                       .1970 * correctionFactor, .1777 * correctionFactor, .1547 * correctionFactor,
		                       .1033 * correctionFactor, .0727 * correctionFactor, .0587 * correctionFactor,
		                       .0470 * correctionFactor, .0372 * correctionFactor, .0285 * correctionFactor,
		                       .0220 * correctionFactor, .0130 * correctionFactor, .0084 * correctionFactor };

	/* TEST: make QE the same!!
	static G4double QE[20] =
	  { 0.00*correctionFactor, .0008*correctionFactor, .1255*correctionFactor, .254962*correctionFactor,
	.2930*correctionFactor, .3127*correctionFactor, .3130*correctionFactor, .2994*correctionFactor,
	.2791*correctionFactor, .2491*correctionFactor, .2070*correctionFactor,  .1758*correctionFactor,
	.1384*correctionFactor, .0779*correctionFactor, .0473*correctionFactor, .0288*correctionFactor,
	.0149*correctionFactor, .0062*correctionFactor, .0002*correctionFactor, .0001*correctionFactor};
	*/
	return QE;
}
...
G4String PMT4inchR12199_02::GetPMTName() {
	G4String PMTName = "PMT4inchR12199_02";
	return PMTName;
}

G4double PMT4inchR12199_02::GetExposeHeight() {
	return .0276 * m;
}  // or 0.021 for radius = 48.5mm

G4double PMT4inchR12199_02::GetRadius() {
	return .054 * m;
}  // radius at z = exposeheight of photocathode. In ConstructPMT, we use sphereRadius for the radius of
   // curvature

G4double PMT4inchR12199_02::GetPMTGlassThickness() {
	return 0.1 * cm;
}
...
G4double* PMT4inchR12199_02::GetQE() {
	static G4double QE[21] = { .0787, .1838, .2401, .2521, .2695, .2676, .2593, .2472, .2276, .1970, .1777,
		                       .1547, .1033, .0727, .0587, .0470, .0372, .0285, .0220, .0130, .0084 };
	return QE;
}
...
G4String PMT5inchR12199_02::GetPMTName() {
	G4String PMTName = "PMT5inchR12199_02";
	return PMTName;
}

G4double PMT5inchR12199_02::GetExposeHeight() {
	return .0338 * m;
}  // or 0.0259 for radius = 60.75mm

G4double PMT5inchR12199_02::GetRadius() {
	return .0675 * m;
}  // radius at z = exposeheight of photocathode. In ConstructPMT, we use sphereRadius for the radius of
   // curvature

G4double PMT5inchR12199_02::GetPMTGlassThickness() {
	return 0.1 * cm;
}
...
G4String PMT3inchR14374::GetPMTName() {
	G4String PMTName = "PMT3inchR14374";
	return PMTName;
}
...
G4double PMT3inchR14374::GetPMTGlassThickness() {
	return 0.1 * cm;
}  // TF: from Hamamatsu Tech Sheet, photocathode >=36mm, so this yields in thickness <= 2.35mm. Currently
   // will use 1mm (larger cathode) until measured!
