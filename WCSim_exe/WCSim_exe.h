	...
	G4RunManager * m_p_run_manager;
		...
		namespace utils {
			...
			/*!
				...
				\param default_value The default value, to use if the environment variable isn't set or is empty
				\return A string containing the environment variable if it is set and is not empty, else the default
			*/
			std::string GetEnvironmentVariableWithDefault(const char * variable,
		...
		}//closes namespace utils
	} //closes namespace GHOST
} //closes namespace HK
#endif
